...
export function Chat({ channel, questionStore, approvalStore, onExit, onUpdate, }) {
    ...
    const approvalSnapshot = React.useSyncExternalStore(listener => approvalStore.subscribe(listener), () => approvalStore.getSnapshot());
