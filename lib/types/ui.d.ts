/**
 * Public surface of the ported Ink core, themed for cc-tui.
 *
 * The original Claude Code source wrapped the Ink core in a themed facade
 * (`src/ink.ts` + design-system ThemedBox/ThemedText). cc-tui does the same:
...
export { default as ScrollBox, type ScrollBoxProps, type ScrollBoxHandle, } from './ink/components/ScrollBox.js';
