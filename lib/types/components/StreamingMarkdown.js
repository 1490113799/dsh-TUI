...
export function StreamingMarkdown({ children, }) {
    ...
    return (_jsxs(Box, { flexDirection: "column", gap: 1, children: [stablePrefix && _jsx(Markdown, { children: stablePrefix }), unstableSuffix && _jsx(Markdown, { children: unstableSuffix })] }));
}
