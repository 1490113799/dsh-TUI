...
export const TIPS: readonly Tip[] = [
  ...
  },
  {
    id: 'keys-ctrl-x',
    group: 'keys',
    zh: 'Ctrl+X 用 $VISUAL 编辑器编辑当前输入',
    en: 'Ctrl+X edits your input in the $VISUAL editor',
  },
  {
    id: 'keys-ctrl-enter',
    group: 'keys',
  ...
  },
  {
    id: 'disp-activity',
    group: 'display',
    zh: '/activity frames comet 换状态行动画（34 种）',
    en: '/activity frames comet changes the spinner (34 presets)',
  },
  {
    id: 'disp-diff-layout',
    group: 'display',
